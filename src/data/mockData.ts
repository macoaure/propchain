...
export const mockProperties: Property[] = [
  {
    ...
    description:
      'Stunning modern loft featuring floor-to-ceiling windows, exposed brick, and premium finishes throughout. Located in the heart of downtown with easy access to transportation.',
    features: [
      'Hardwood Floors',
      'In-Unit Laundry',
      'Gym Access',
  ...
  },
  {
    ...
    description:
      'Exceptional luxury estate with panoramic city views, gourmet kitchen, master suite with spa-like bathroom, and resort-style backyard.',
  ...
  },
  {
    ...
    description:
      'Charming studio in historic Brooklyn Heights with beautiful views of the Manhattan skyline. Perfect for young professionals.',
  ...
  },
  {
    ...
    description:
      'Exclusive penthouse with direct ocean access, private elevator, and world-class amenities. The epitome of luxury coastal living.',
  ...
  },
  {
    ...
    description:
      'Beautifully restored Victorian brownstone with original architectural details, modern updates, and private garden.',
    features: [
      'Original Details',
      'Private Garden',
      'Fireplace',
  ...
  },
  {
    ...
    description:
      'Stunning mountain retreat with panoramic views, ski-in/ski-out access, and luxury mountain amenities.',
  ...
  },
  {
    ...
    description:
      'Contemporary home in the heart of Silicon Valley with smart home technology, solar panels, and modern design.',
    features: [
      'Smart Home',
      'Solar Panels',
  ...
  },
  {
    ...
    description:
      'Sophisticated condo in trendy SoHo with high-end finishes, floor-to-ceiling windows, and premium building amenities.',
    features: [
      'City Views',
      'Doorman',
      'Fitness Center',
  ...
  },
  {
    ...
    description:
      'Breathtaking lakefront villa with private dock, panoramic lake views, and luxury amenities. Perfect for year-round living or vacation home.',
  ...
  },
  {
    ...
    description:
      "Modern high-rise apartment with stunning city and water views. Located in the heart of Seattle's financial district.",
  ...
  },
  {
    ...
    description:
      'Perfect family home in quiet suburban neighborhood with excellent schools, large backyard, and updated kitchen.',
  ...
  },
  {
    ...
    description:
      'Spectacular beachfront estate with direct beach access, infinity pool, and unobstructed ocean views. Architectural masterpiece.',
  ...
  },
  {
    ...
    description:
      'Creative loft space in the vibrant Arts District with high ceilings, exposed brick, and natural light perfect for artists.',
    features: [
      'High Ceilings',
      'Exposed Brick',
      'Natural Light',
  ...
  },
  {
    ...
    description:
      'Ultra-modern penthouse with smart home integration, panoramic bay views, and premium finishes throughout.',
  ...
  },
  {
    ...
    description:
      'Magnificent country estate on 5 acres with vineyard views, wine cellar, and entertaining spaces. Perfect for luxury living.',
  ...
  },
  {
    ...
    description:
      'Stylish townhouse in historic Capitol Hill with modern updates, private patio, and walking distance to metro.',
    features: [
      'Private Patio',
      'Metro Access',
      'Updated Kitchen',
  ...
  },
  {
    ...
    description:
      'Elegant high-rise condo with river views, premium finishes, and world-class building amenities in River North.',
  ...
  },
  {
    ...
    description:
      'Stunning desert modern home with mountain views, resort-style pool, and indoor-outdoor living spaces.',
    features: [
      'Mountain Views',
      'Resort Pool',
      'Outdoor Kitchen',
  ...
  },
  {
    ...
    description:
      'Magnificent antebellum mansion in the prestigious Garden District with original architectural details and modern amenities.',
    features: [
      'Historic Details',
      'Grand Staircase',
      'Formal Gardens',
  ...
  },
  {
    ...
    description:
      'Beautifully designed minimalist studio in charming West Village with modern amenities and classic NYC character.',
    features: [
      'Minimalist Design',
      'Modern Kitchen',
      'Exposed Brick',

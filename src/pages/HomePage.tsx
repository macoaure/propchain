        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto animate-fade-in delay-300">
              Discover luxury real estate with blockchain technology. Secure, transparent, and
              revolutionary property investments.
            </p>
      ...
      <section className="py-16 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Market Overview</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600 mb-2">
                {mockMarketData.totalProperties.toLocaleString()}+
              </div>
              <div className="text-gray-600">Properties Listed</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-emerald-600 mb-2">
                {mockMarketData.totalValue}
              </div>
              <div className="text-gray-600">Total Value</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-orange-600 mb-2">
                {mockMarketData.nftProperties}
              </div>
              <div className="text-gray-600">NFT Properties</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-600 mb-2">
                {mockMarketData.monthlyGrowth}
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Experience the future of real estate with blockchain-powered transparency and
              security.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow group">
              ...
              <p className="text-gray-600">
                Every transaction is secured by blockchain technology, ensuring transparency and
                immutable records.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow group">
              ...
              <p className="text-gray-600">
                Smart contracts enable instant property verification and seamless ownership
                transfers.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow group">
              ...
              <p className="text-gray-600">
                Own unique digital property tokens that represent real estate assets on the
                blockchain.
              </p>
            </div>
          </div>

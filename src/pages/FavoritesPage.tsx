    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50/30 to-red-50/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 relative z-10">
          ...
          <p className="text-xl text-gray-600">Your saved properties are here for easy access.</p>
        </div>
          ...
          <>
            <div className="mb-6 relative z-10">
              <span className="text-gray-600">
                <span className="font-semibold text-gray-900">{favoriteProperties.length}</span>{' '}
                saved properties
              </span>
            </div>

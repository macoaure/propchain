            ...
            {walletInfo.isConnected ? (
                ...
                <div>
                    ...
                    <div className="mb-4 p-3 bg-blue-50 text-blue-700 rounded-lg">
                        <p className="text-sm"><strong>Important:</strong> To disconnect from this dApp later, you'll need to use MetaMask directly. When clicking "Disconnect", you'll be redirected to MetaMask's instructions.</p>
                    </div>
